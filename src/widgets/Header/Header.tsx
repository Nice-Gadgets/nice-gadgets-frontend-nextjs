...
const headerIconLinkClassName =
  'hidden h-full w-16 items-center justify-center border-l border-brand-elements text-text-primary transition-colors hover:bg-brand-surface-1 md:flex lg:w-22';
...
export const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-brand-elements bg-bg-primary">
      <div className="flex h-11.75 items-center justify-between lg:h-16">
        ...
        <div className="flex h-full items-center">
          ...
          <UserAnchor className="hidden h-full w-16 items-center justify-center border-l border-brand-elements text-text-primary transition-colors hover:bg-brand-surface-1 md:flex lg:w-22" />
